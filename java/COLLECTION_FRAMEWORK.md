...
- **<mark>저장 순서가 유지되는 collection을 구현하는데 사용</mark>**
- 같은 요소의 중복 저장 허용
...
### 🟥 특징
- <mark>**FIFO(First-In-First-Out) 구조**</mark>
...
### 🟥 특징
- <mark>**데이터의 중복을 허용하지 않고 순서를 유지하고 있는 데이터 집합 리스트**</mark>
...
### 🟥 특징
- <mark>**키(Key)와 값(value)의 쌍으로 연관지어 이루어진 데이터의 집합**</mark>
- 키 : 고유한 값, 값 : 중복을 허용
